  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        {/* Main Content */}
        <main className="p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Calificaciones</h1>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600">Aquí se mostrarán tus calificaciones y progreso académico.</p>
          </div>
        </main>
      </div>
    </>
