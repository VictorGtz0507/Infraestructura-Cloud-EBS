...
export const RegisterPage: React.FC = () => {
  ...
  const roleOptions = [
    { value: 'student', label: 'Estudiante', description: 'Acceso a cursos y materiales' },
    { value: 'teacher', label: 'Profesor', description: 'Crear y gestionar cursos' },
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  name="role"
                  required
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  value={formData.role}
                  onChange={handleChange}
                >
